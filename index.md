...
#### To Usernames
> Any &rarr; Usernames returns `maltego.Alias`
...
#### To Credit Cards
> Any &rarr; Credit Cards returns `maltego.BankAccount`
...
#### To IIN
> Any &rarr; IIN returns `maltego.BankAccount`
...
#### To Hashtags
> Any &rarr; Hashtags returns `maltego.hashtag`
...
> Any &rarr; Documents returns `maltego.Document`

> Find documents that are related to the seed

Returns the documents that are the most related to your seed. The returned documents contains the URL to the original document on source website as well as Silobreaker URL for further analysis.
...
#### To Products
> Any &rarr; Products returns `maltego.Phrase`
...
#### To Email Domains
> Any &rarr; Email Domains returns `maltego.Domain`
...
#### To Pastes
> Any &rarr; Pastes returns `maltego.Document`
...
#### To Vulnerabilities
> Any &rarr; CVE-identifiers returns `maltego.Vulnerability`
...
#### To Hashes
> Any &rarr; Hashes returns `maltego.Hash` 
...
#### To Malware
> Any &rarr; Malware returns `maltego.Explosive`
...
#### To Threat Actor
> Any &rarr; Threat Actor returns `maltego.Gang`
...
#### To Hacker Groups
> Any &rarr; Hacker Groups returns `maltego.affiliation.Affiliation`

> Find related Hacker Groups

Silobreaker identifies Hacker Groups and their aliases in document. Eg. 'Syrian Electronic Army', 'Desert Falcons', or 'Team GhostShell'.

#### To Hacker Ops
> Any &rarr; Hacker Ops returns `maltego.Phrase`
...
> Any Silobreaker Entity &rarr; Link to Evidence `maltego.Document`
...
4. The children that are generated are `maltego.Documents` containing url's to the documents that generated this relation on Silobreaker.
